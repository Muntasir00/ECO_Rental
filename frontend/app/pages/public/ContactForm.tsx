...
const ContactForm = () => {
  ...
  const inputStyles =
    'bg-white/20 border-transparent text-white placeholder:text-white/70 focus-visible:ring-white/50 focus-visible:bg-white/30 transition-all duration-200';
      ...
      <div className='max-w-7xl mx-auto bg-[#B83E25] rounded-lg shadow-lg overflow-hidden py-16 px-6 md:px-20'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-[#fafafa] text-sm md:text-base max-w-lg mx-auto leading-relaxed'>
            ...
            Customer Service Team will contact you
          </p>
        </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
          ...
          <div className='pt-8 flex justify-center'>
            <button
              type='submit'
              className='bg-white text-[#B83E25] hover:bg-gray-50 font-medium py-3 px-16 rounded-sm shadow-md transition-colors w-full md:w-auto text-center'
            >
              Send
            </button>
          </div>
