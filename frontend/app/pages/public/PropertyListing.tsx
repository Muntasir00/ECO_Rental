      ...
      <div className='max-w-7xl mx-auto'>
              ...
              <Link to={`/room/${room._id}`} key={room._id}>
                <div className='group cursor-pointer flex flex-col gap-4'>
                  ...
                  <div className='relative rounded-2xl overflow-hidden aspect-[4/3] bg-gray-100 shadow-sm'>
                    ...
                    <button className='absolute top-4 right-4 bg-white/90 hover:bg-white p-2 rounded-full shadow-sm transition-colors text-gray-700 hover:text-red-500'>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <div className='flex items-start gap-2'>
                      ...
                      <div className='flex items-center gap-1 bg-pink-100 text-[#B83E25] px-2 py-1 rounded-md text-xs font-bold mt-1'>
                        <span>★</span>
                        <span>4.8</span>
                      </div>
        ...
        <div className='mt-20 flex flex-col items-center gap-4'>
          ...
          <Link to='/rooms' className='cursor-pointer'>
            <button className='cursor-pointer bg-[#B83E25] text-white px-8 py-3 rounded-md font-medium shadow-lg shadow-red-100 hover:bg-[#d4444b] transition-all transform active:scale-95'>
              Continue Browsing
            </button>
          </Link>
        </div>
