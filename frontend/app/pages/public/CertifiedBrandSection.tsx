        ...
        <section className="bg-white py-20 px-4 sm:px-6 lg:px-8 font-sans">
          ...
          ======================== */}
                    <div className="flex flex-col justify-between items-start">
                        ...
                        <button
                            className="bg-[#E5555C] hover:bg-[#d4444b] text-white px-10 py-3.5 rounded-sm font-medium transition-colors shadow-sm">
                            Find Place
                        </button>
                    </div>
          ...
          ======================== */}
                    <div className="flex flex-col justify-start pt-2 lg:pt-4">
                        ...
                        <div className="flex flex-wrap gap-8 md:gap-12 mb-10 text-gray-400">
                            <AwardBadge title="HYPER BEST" subtitle="AWARD WINNING" stars={5}/>
                        ...
                        <p className="text-gray-500 text-lg leading-relaxed max-w-xl">
                            Lorem ipsum dolor sit amet consectetur. Lacus ut enim turpis imperdiet. Lorem ipsum dolor
                            sit amet consectetur. Lacus ut enim turpis imperdiet.
                        </p>
                    </div>
    ...
    return (
        <div className="flex flex-col items-center justify-center opacity-80 hover:opacity-100 transition-opacity">
            ...
            <div className="relative w-20 h-20 md:w-24 md:h-24 flex items-center justify-center">
                ...
                >
                    {/* Left Branch */}
                    <path d="M50 85 C 30 85, 10 60, 10 30 C 10 25, 15 20, 20 25 C 15 30, 20 50, 35 60"
                          stroke="currentColor" strokeWidth="3" fill="none" strokeLinecap="round"/>
                    <path d="M15 35 C 10 40, 15 50, 25 55" stroke="currentColor" strokeWidth="2" fill="none"/>
                    <path d="M12 45 C 10 50, 15 60, 28 65" stroke="currentColor" strokeWidth="2" fill="none"/>

                    {/* Right Branch */}
                    <path d="M50 85 C 70 85, 90 60, 90 30 C 90 25, 85 20, 80 25 C 85 30, 80 50, 65 60"
                          stroke="currentColor" strokeWidth="3" fill="none" strokeLinecap="round"/>
                    <path d="M85 35 C 90 40, 85 50, 75 55" stroke="currentColor" strokeWidth="2" fill="none"/>
                    <path d="M88 45 C 90 50, 85 60, 72 65" stroke="currentColor" strokeWidth="2" fill="none"/>
                </svg>
                ...
                <div className="relative z-10 flex flex-col items-center pt-2">
                    ...
                    <div className="flex gap-[1px] mb-1">
                        {[...Array(stars)].map((_, i) => (
                            <span key={i} className="text-[6px] text-gray-400">★</span>
                        ))}
                    </div>
                    <span
                        className="text-[8px] md:text-[10px] font-bold text-gray-500 uppercase leading-none text-center">
            {title}
          </span>
