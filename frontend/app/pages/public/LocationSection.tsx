...
const LocationSection = ({ bgColor = '#F5F5F5' }) => {
  return (
    <section
      className={`max-w-7xl mx-auto bg-[${bgColor}] py-16 px-4 sm:px-6 lg:px-8 mb-8`}
    >
      ...
      <div className='relative w-full h-[300px] md:h-[400px] lg:h-[450px] bg-gray-200 overflow-hidden shadow-sm'>
        ...
        <div className='absolute top-1/2 left-10 hidden md:block text-gray-400 font-medium -rotate-90 text-sm tracking-widest'>
          Alabama St
        </div>
        <div className='absolute top-1/2 right-20 hidden md:block text-gray-400 font-medium -rotate-90 text-sm tracking-widest'>
          Utah St
        </div>
        <div className='absolute bottom-4 right-1/4 hidden md:block text-gray-400 font-medium text-sm tracking-widest'>
          16th St
        </div>
      </div>
    </section>
