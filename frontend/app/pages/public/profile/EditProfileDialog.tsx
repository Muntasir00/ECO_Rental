        ...
        <Form {...form}>
          ...
          >
            ...
            <FormItem>
              ...
              {identityPreview ? (
                <div className='relative w-full h-48 rounded-lg overflow-hidden border border-gray-200 group bg-gray-50 flex items-center justify-center'>
                ...
                <div className='border-2 border-dashed border-gray-200 rounded-lg p-6 flex flex-col items-center justify-center bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer relative h-48'>
                  <Input
                    type='file'
            ...
            <DialogFooter className='gap-2 sm:gap-0'>
              ...
              <Button
                type='submit'
                className='bg-[#B83E25] hover:bg-[#d4444b] text-white'
