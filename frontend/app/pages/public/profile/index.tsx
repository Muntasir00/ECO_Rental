                        ...
                        >
                            ...
                            <div>
                                {item.isEditable ? (
                                    ...
                                    <EditProfileDialog
                                        triggerButton={
                                            <button className="text-[#1A1A1A] text-sm font-medium underline underline-offset-4 decoration-1 hover:text-[#E5555C] hover:decoration-[#E5555C] transition-all">
                                                Edit
                                            </button>
                                        }
                                    />
                            ...
                            {user?.isVerified ? (
                                <Dialog>
                                    <DialogTrigger asChild>
                                        <button className="cursor-pointer text-[#1A1A1A] text-sm font-medium underline hover:text-[#E5555C] outline-none">
                                            View
                                        </button>
                                    </DialogTrigger>
                                    ...
                                    <DialogContent className="sm:max-w-[600px] p-6">
                                        ...
                                        <div className="mt-4 flex items-center justify-center bg-gray-50 rounded-lg p-2 border border-gray-100">
                                            {user?.identityFile ? (
                                                ...
                                                <p className="text-sm text-gray-500 py-10">No document image found.</p>
                                            )}
                                        </div>
                                    </DialogContent>
                                </Dialog>
                                ...
                                <EditProfileDialog
                                    triggerButton={
                                        <button className="cursor-pointer text-[#1A1A1A] text-sm font-medium underline hover:text-[#E5555C]">
                                            Start Verification
                                        </button>
                                    }
                                />
...
//                             <div>
//                                 <button
//                                     className="cursor-pointer text-[#1A1A1A] text-sm font-medium underline underline-offset-4 decoration-1 hover:text-[#E5555C] hover:decoration-[#E5555C] transition-all">
//                                     {item.action}
//                                 </button>
//                             </div>
//
