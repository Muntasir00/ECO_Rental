  ...
  const slides = [
    {
      id: 1,
      image:
        'https://images.unsplash.com/photo-1595526114035-0d45ed16cfbf?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80', // Forest cabin
      title: 'Welcome to Eco Rentals - Sustainable Living Made Easy',
      subtitle:
        'At EcoRentals, we believe in a world where sustainability and convenience go hand in hand. Our platform offers an eco-friendly way to rent high-quality products.',
    },
    {
      id: 2,
      image:
        'https://images.unsplash.com/photo-1470770841072-f978cf4d019e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80', // Nature landscape
      title: 'Reconnect with Nature',
      subtitle:
        'Escape the city and find peace in our curated selection of eco-friendly retreats designed to minimize footprint and maximize comfort.',
    },
    {
      id: 3,
      image:
        'https://images.unsplash.com/photo-1510798831971-661eb04b3739?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80', // Adventure
      title: 'Experience the Outdoors',
      subtitle:
        'From hiking gear to camping essentials, rent everything you need for your next adventure without the waste of buying new.',
    },
  ];
        ...
        <div className='relative z-40 -mt-20 pb-20'>
          <div className='max-w-6xl mx-auto bg-white rounded-lg shadow-2xl p-6 mb-20 md:p-8'>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-0'>
              ...
              {/* 4. Rooms & Button */}
              <div className='flex flex-col md:flex-row lg:flex-row items-center justify-between gap-4 lg:pl-6'>
                {/* Rooms Dropdown */}
                ...
                {/* Search Button */}
                <button className='w-full md:w-auto bg-[#B83E25] hover:bg-[#d4444b] text-white font-medium py-3 px-8 rounded-sm transition-all shadow-md active:scale-95 flex items-center justify-center gap-2'>
