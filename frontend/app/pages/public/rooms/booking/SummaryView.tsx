        ...
        <div className="animate-in fade-in slide-in-from-right-4 duration-500">
            <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between items-center text-sm">
                    ...
                    <span
                        className="font-medium text-gray-900">{data.checkIn ? format(data.checkIn, "dd MMM yyyy") : "-"}</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                    <span className="text-gray-500">Check Out</span>
                    <span
                        className="font-medium text-gray-900">{data.checkOut ? format(data.checkOut, "dd MMM yyyy") : "-"}</span>
                </div>
                <div className="flex justify-between items-center text-sm">
            ...
            <div
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium text-gray-900">Master Card</span>
                    </div>
                </div>
            ...
            <div className="flex justify-end gap-4 flex-wrap">
                ...
                <Button onClick={onSubmit} disabled={isLoading}
                        className="bg-[#E5555C] text-white px-10 py-6 hover:bg-[#d4444b] w-full md:w-auto">
