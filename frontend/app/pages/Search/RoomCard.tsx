        ...
        <div className="group flex flex-col gap-3 bg-transparent">
            ...
            <div className="relative h-[280px] w-full overflow-hidden rounded-2xl">
                ...
                <div className="absolute top-3 right-3">
                    <Button size="icon" variant="ghost" className="h-10 w-10 rounded-full bg-white/70 hover:bg-white backdrop-blur-sm text-gray-700 hover:text-red-500">
            ...
            <div className="flex flex-col gap-1">
                ...
                <div className="flex items-center gap-2">
                    <span className="inline-flex items-center gap-1 rounded-sm bg-pink-100 px-2 py-0.5 text-xs font-bold text-pink-600">
                        ★ {rating.toFixed(1)}
                    </span>
