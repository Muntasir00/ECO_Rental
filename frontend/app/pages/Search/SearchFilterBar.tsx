      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-0 w-full'>
        ...
        <div className='flex flex-col gap-2 lg:border-r border-gray-200 lg:px-6'>
          ...
          <Popover open={checkInOpen} onOpenChange={setCheckInOpen}>
            <PopoverTrigger asChild>
              <Button
                variant='ghost'
                className='w-full justify-between font-semibold border-0 shadow-none px-0 hover:bg-transparent text-left'
              >
                {checkInDate ? (
        ...
        <div className='flex flex-col md:flex-row items-center gap-4 lg:pl-6'>
          ...
          <Button
            ...
            className='w-full md:w-auto bg-[#B83E25] hover:bg-[#d4444b] text-white font-medium py-6 px-8 rounded-lg transition-all shadow-md active:scale-95 flex items-center justify-center gap-2'
          >
