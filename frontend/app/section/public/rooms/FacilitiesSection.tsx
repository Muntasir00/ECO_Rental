...
const FacilitiesSection = () => {
    ...
    const facilities = [
        {
            ...
            icon: (
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"
                    ...
                    <path
                        d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.05 12.05 0 0 0 .57 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.03 12.03 0 0 0 2.81.57A2 2 0 0 1 22 16.92z"></path>
                </svg>
            )
        },
        {
    ...
    return (
        <>
            <div className="bg-[#E5555C] rounded-sm py-6 px-6 md:px-12 mt-10">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-y-10 gap-x-4">
                        ...
                        {facilities.map((item) => (
                            <div key={item.id}
                                ...
                                {/* Icon */}
                                <div
                                    className="text-[#E5555C] mb-4 transform transition-transform duration-300 group-hover:-translate-y-1">
                                    {item.icon}
                                </div>
