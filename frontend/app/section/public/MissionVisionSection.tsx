      ...
      <div className='max-w-7xl mx-auto'>
        ...
        */}
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 auto-rows-[320px]'>
          ...
          <div className='bg-[#B83E25] rounded-3xl p-8 flex flex-col justify-center items-center text-center text-white hover:shadow-lg transition-shadow duration-300'>
