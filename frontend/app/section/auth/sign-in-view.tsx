    ...
    return (
        <>
            <div className="min-h-screen bg-gray-50 flex items-center justify-center sm:p-4 font-sans">
                <div
                    className="relative w-full max-w-6xl h-[900px] md:h-[850px] bg-black sm:rounded-[10px] overflow-hidden shadow-2xl">
                    ...
                    <div className="absolute inset-0 z-10 flex items-center justify-center p-2 sm:p-6 overflow-y-auto">
                        ...
                        <div
                            ...
                            {/* Glossy Effect */}
                            <div
                                className="absolute top-0 left-0 w-full h-1/2 bg-gradient-to-b from-white/5 to-transparent pointer-events-none"></div>
                            ...
                            <div className="relative z-10 flex flex-col items-center">
                                ...
                                <div className="flex items-center gap-3 mb-6 sm:mb-8">
                                    <div
                                        className="w-10 h-10 rounded-full border-2 border-[#E5555C] flex items-center justify-center p-1.5">
                                        <svg viewBox="0 0 24 24" fill="none" className="w-full h-full text-[#E5555C]"
                                    ...
                                    <div className="flex flex-col">
                                        <span
                                            className="text-white text-lg font-serif tracking-wider">LAND OF NOMADS</span>
                                        <span
                                            className="text-[#E5555C] text-[9px] font-bold tracking-[0.3em] uppercase">ECO RENTALS</span>
                                    </div>
                                </div>

                                {/* 2. Header */}
                                <h2 className="text-2xl sm:text-3xl font-medium text-[#E5555C] mb-2">Welcome Back!</h2>
                                <p className="text-gray-300 text-sm mb-6 sm:mb-8">Log In To Your Account</p>
                                    ...
                                    <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-5">
                                        ...
                                        <FormField
                                            ...
                                            render={({field}) => (
                                                <FormItem className="space-y-1">
                                                    <FormLabel className="text-xs text-white/80 ml-1">Email</FormLabel>
                                                    <FormControl>
                                                        <Input
                                                            placeholder="hikari@company.com"
                                                            type="email"
                                                            // Merging your original styles with shadcn Input
                                                            className="w-full bg-transparent border-gray-400/50 rounded-lg px-4 py-6 text-white placeholder:text-gray-400 focus-visible:ring-0 focus-visible:border-[#E5555C] focus-visible:ring-offset-0 transition-all"
                                                            {...field}
                                                        />
                                                    </FormControl>
                                        ...
                                        <FormField
                                            ...
                                            render={({ field, fieldState }) => (
                                                <FormItem className="space-y-1">
                                                    <FormLabel className="text-xs text-white/80 ml-1">Password</FormLabel>
                                                    <FormControl>
                                                            ...
                                                            <Input
                                                                ...
                                                                className={cn(
                                                                    ...
                                                                    fieldState.error
                                                                        ...
                                                                        : "border-gray-400/50 focus-visible:border-[#E5555C]"
                                                                )}
                                                            />
                                                            <button
                                                                type="button"
                                        ...
                                        <div className="flex justify-between items-center mt-2">
                                            <FormField
                                                ...
                                                render={({field}) => (
                                                    <FormItem
                                                        className="flex flex-row items-center space-x-2 space-y-0 cursor-pointer group">
                                                        <FormControl>
                                                            <Checkbox
                                                                checked={field.value}
                                                                onCheckedChange={field.onChange}
                                                                className="w-4 h-4 border-gray-400 rounded bg-transparent data-[state=checked]:bg-[#E5555C] data-[state=checked]:border-[#E5555C] data-[state=checked]:text-white transition-all"
                                                            />
                                                        </FormControl>
                                                        <div className="space-y-1 leading-none">
                                                            <FormLabel
                                                                className="text-xs text-gray-300 group-hover:text-white transition-colors cursor-pointer font-normal">
                                                                Remember Me
                                                            </FormLabel>
                                                        </div>
                                                    </FormItem>
                                        ...
                                        <Button
                                            ...
                                            className="w-full bg-[#E5555C] hover:bg-[#d4444b] text-white font-medium py-6 rounded-lg shadow-lg shadow-red-900/20 transition-all active:scale-[0.98] mt-4"
                                        >
                                ...
                                <div className="w-full mt-6">
                                    <div className="relative flex items-center justify-center mb-6">
                                        ...
                                        <span
                                            className="relative px-3 text-xs text-gray-400 bg-transparent uppercase tracking-wider">
                    Or Login With
                  </span>
                                    </div>
